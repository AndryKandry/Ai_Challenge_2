...
class ChatManager(
    ...
    private val jsonSystemPrompt = """
        ...
        Отвечай на все вопросы строго в формате JSON:
        {
            "question": "вопрос от пользователя в краткой форме",
            "answer": "твой ответ на вопрос пользователя"
        }
        Не добавляй никакого текста до или после JSON. Только валидный JSON объект.
    """.trimIndent()
